...
export default function MortgageCalc() {
  ...
  const calculate = () => {
    ...
    const newResults = {
      ...
      startMonth, startYear, monthlyRate, mortgagePayment,
    };
  ...
  const calculateExtra = (res, extra) => {
    ...
    const { loanAmount, monthlyRate, mortgagePayment, startMonth, startYear, n, totalInterest } = res;

    // Simulate payoff with extra principal
    let balance = loanAmount;
    ...
    while (balance > 0 && months < n) {
      months++;
      const interestPmt = balance * monthlyRate;
      const principalPmt = mortgagePayment - interestPmt + extra;
    ...
    const totalPaidWithExtra = totalInterestWithExtra + loanAmount;
    ...
    setExtraResults({
      ...
      newEndMonth: endM,
      newEndYear: endY,
      newMonthlyPayment: mortgagePayment + extra,
      totalPaidWithExtra,
    });
  };
      ...
      {!results ? (
        ...
        <div className="results-area">
          ...
          <div className="card extra-principal-card fade-in fade-in-d3">
            <div className="toggle-header" onClick={() => setExtraOpen(o => !o)} style={{ paddingTop: 0 }}>
            ...
            <div className={`toggle-content${extraOpen ? ' open' : ''}`} style={{ maxHeight: extraOpen ? '1200px' : '0' }}>
                ...
                <div className="extra-results-area">
                  <div className="extra-savings-banner">
                    ...
                    <div className="extra-savings-text">
                      ...
                      <span className="extra-savings-detail">
                        and pay off your mortgage <strong>
                  ...
                  <div className="extra-compare-grid">
                    <div className="extra-compare-card">
                      ...
                      <div className="extra-compare-value">{fullMonthNames[results.endMonth]} {results.endYear}</div>
                      <div className="extra-compare-sub">{results.n} months · {fmt(results.totalInterest)} interest</div>
                    </div>
                  ...
                  <div className="extra-chart-wrap">
                    <ExtraCompareChart
                      ...
                      original={{ interest: results.totalInterest, months: results.n }}
...
function ExtraCompareChart({ original, withExtra }) {
  ...
  const options = {
    ...
    scales: {
      x: {
        ticks: { color: cc.tick, font: { family: 'DM Sans', size: 10 }, callback: (v, i) => '' },
